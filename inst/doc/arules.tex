...
checking subsets of size 1 2 3 4 5 done [0.98s].
...
\begin{Soutput}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
0.05004 0.05053 0.05115 0.05152 0.05221 0.05516 
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
0.05005 0.05038 0.05092 0.05118 0.05179 0.05461 
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
 0.8749  0.9626  0.9788  0.9742  0.9900  1.0000 
\end{Soutput}
\end{Schunk}
...
Also, the impelentation of distance based
